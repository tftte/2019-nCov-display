...
public interface EpidemicMapper {
     ...
     * @return
     */
    @Insert("INSERT INTO epidemics(province_id,data_year,data_month,data_day,affirmed,suspected, " +
     ...
     * @return
     */
    @Select("SELECT e1.province_id,temp.province_name,e1.data_year,e1.data_month,e1.data_day," +
